...
const About = () => {
    return (
        <div className="my-10 px-10 grid grid-cols-2 items-center gap-8">
            {/**========== about-left-section */}
            <div className="space-y-6 mt-8">
                <h1 className='font-playfair font-extrabold text-4xl w-[500px]'>Explore our tailor made package for you</h1>
                <p className='w-[350px] '>To get the best  of your adventure you just need to leave and go where you like. we are waiting for you</p>
